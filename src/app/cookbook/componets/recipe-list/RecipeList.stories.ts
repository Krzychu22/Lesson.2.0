  ...
  .add('Many with wery long name', () => ({
    props: {
      ...
      recipes: [
        {
          name:
            'Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy' +
            'Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy ' +
            'Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy ' +
            'Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy ' +
            'Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy Pierwszy ',
          components: [],
          realization: [],
          mealId: 'asdasd',
          recipeId: ['asdasd'],
